// Volkihar project assets (public folder)
const volkiharBackgroundLarge = "/volkihar-background-large.jpg";
const volkiharBackgroundPlaceholder = "/volkihar-background-placeholder.jpg";
const volkiharBackground = "/volkihar-background.jpg";
const volkiharBannerLarge = "/volkihar-banner-large.jpg";
const volkiharBannerPlaceholder = "/volkihar-banner-placeholder.jpg";
const volkiharBanner = "/volkihar-banner.jpg";
const volkiharBookLarge = "/volkihar-book-large.png";
const volkiharBookPlaceholder = "/volkihar-book-placeholder.png";
const volkiharBook = "/volkihar-book.png";
const volkiharEnderalLarge = "/volkihar-enderal-large.jpg";
const volkiharEnderalLogoLarge = "/volkihar-enderal-logo-large.png";
const volkiharEnderalLogoPlaceholder = "/volkihar-enderal-logo-placeholder.png";
const volkiharEnderalLogo = "/volkihar-enderal-logo.png";
const volkiharEnderalPlaceholder = "/volkihar-enderal-placeholder.jpg";
const volkiharEnderal = "/volkihar-enderal.jpg";
const volkiharSlide1Large = "/volkihar-slide-1-large.jpg";
const volkiharSlide1 = "/volkihar-slide-1.jpg";
const volkiharSlide2Large = "/volkihar-slide-2-large.jpg";
const volkiharSlide2 = "/volkihar-slide-2.jpg";
const volkiharSlide3Large = "/volkihar-slide-3-large.jpg";
const volkiharSlide3 = "/volkihar-slide-3.jpg";
const volkiharSlidePlaceholder = "/volkihar-slide-placeholder.jpg";
