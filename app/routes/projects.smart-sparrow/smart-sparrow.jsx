...
const title = 'API Marketplace Platform';
const description =
  'Developed a web-based platform to sell and integrate AI-powered APIs. Focused on secure integration, smooth onboarding, and providing developers with easy access to scalable services.';
const roles = [
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://apistudio.artivatic.ai/home"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              Modern applications rely heavily on APIs, but many teams struggle with
              managing complexity, ensuring consistency, and maintaining scalability.
              Traditional approaches often result in duplicated effort, fragmented
              documentation, and limited visibility into how APIs are consumed.
              These gaps make collaboration harder between frontend and backend teams and
              slow down delivery speed.
              The challenge was to design a platform that reduces these barriers, provides
              clear standards, and makes API development more efficient without sacrificing
              flexibility or future growth.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
